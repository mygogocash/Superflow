import type { QuestionInput } from "@/services/survey-form.service";
...
export const GO_EXTRA_MILE_AWARD_TEMPLATE: SurveyFormTemplate = {
...
export const KUDO_AWARDS_TEMPLATE: SurveyFormTemplate = {
  id: "kudo-awards",
...
export const SURVEY_FORM_TEMPLATES: SurveyFormTemplate[] = [
  GO_EXTRA_MILE_AWARD_TEMPLATE,
  KUDO_AWARDS_TEMPLATE,
];

export function getSurveyFormTemplate(
  id: string,
): SurveyFormTemplate | undefined {
  return SURVEY_FORM_TEMPLATES.find((t) => t.id === id);
}
